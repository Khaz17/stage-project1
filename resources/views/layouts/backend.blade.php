                ...
                <div>
                    ...
                    <div class="dropdown d-inline-block ms-1">
                        ...
                        <div class="dropdown-menu dropdown-menu-end fs-sm smini-hide border-0"
                            ...
                            <a class="dropdown-item d-flex align-items-center justify-content-between font-medium"
                                data-toggle="theme" data-theme="{{ mix('css/themes/modern.css') }}"
                                href="#">
                                <span>Modern</span>
                                <i class="fa fa-circle text-modern"></i>
                            </a>
                            <a class="dropdown-item d-flex align-items-center justify-content-between font-medium"
                                data-toggle="theme" data-theme="{{ mix('css/themes/smooth.css') }}"
                                href="#">
                                <span>Smooth</span>
                ...
                <div class="content-side">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item{{ request()->is('pages/*') ? ' open' : '' }}">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('marques/marques.list') ? ' active' : '' }}"
                                        href="{{ route('marques.list') }}">
                                        <span class="nav-main-link-name">Marques de voitures</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('modeles/modeles.list') ? ' active' : '' }}"
                                        href="{{ route('modeles.list') }}">
                                        <span class="nav-main-link-name">Modèles de voitures</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('typesmoteurs/typesmoteurs.list') ? ' active' : '' }}"
                                        href="{{ route('typesmoteurs.list') }}">
                                        <span class="nav-main-link-name">Types de moteur</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-main-item{{ request()->is('pages/*') ? ' open' : '' }}">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                                ...
                                <span class="nav-main-link-name">Conducteurs</span>
                            </a>
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
